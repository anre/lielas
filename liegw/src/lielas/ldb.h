...
#define LDB_TBL_CONTENT_DEVICES         "(id integer NOT NULL, address text, mac text, registered boolean, name text, dev_group text, mint text, moduls text, datapakets integer, router boolean, datalogger boolean, v_source text, v_source_state text, sw_ver text, route_id integer, PRIMARY KEY(id))"
#define LDB_TBL_CONTENT_MODULS          "(id integer NOT NULL, address text, channels text, mint text, PRIMARY KEY(id))"
...
#define LDB_SQL_SET_NAME_NET_DNS1         "NET_DNS1"
#define LDB_SQL_SET_NAME_NET_DNS2         "NET_DNS2"
...
#define LDB_SQL_SET_NAME_NET_NEW_DNS1     "NET_NEW_DNS1"
#define LDB_SQL_SET_NAME_NET_NEW_DNS2     "NET_NEW_DNS2"
#define LDB_SQL_SET_NAME_GW_REG_ADR       "GW_REG_ADR"
#define LDB_SQL_SET_NAME_GW_NOR_ADR       "GW_NOR_ADR"
#define LDB_SQL_SET_NAME_LOG_COUNT        "LOG_COUNT"
