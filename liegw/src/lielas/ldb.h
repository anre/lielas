...
#define LDB_TBL_CONTENT_DEVICES         "(id integer NOT NULL, address text, mac text, registered boolean, name text, dev_group text, mint text, moduls text, datapakets integer, router boolean, datalogger boolean, v_source text, v_source_state text, sw_ver text, PRIMARY KEY(id))"
