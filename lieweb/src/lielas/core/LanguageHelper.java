...
public class LanguageHelper  implements Serializable{
	...
	public static String DM_TAB_REGISTER = "DM_TAB_REGISTER";
	...
	public static String DM_TABLE_DL_DETAILS_SUPPLY_STATE = "DM_TABLE_DL_DETAILS_SUPPLY_STATE";
	...
	public static String DM_TAB_RED_START_REG_BTTN = "DM_TAB_RED_START_REG_BTTN";
	...
	public static String SET_TABSHEET_TAB_GLOBAL_VERSION = "SET_TABSHEET_TAB_GLOBAL_VERSION";
	public static String SET_TABSHEET_TAB_GLOBAL_PANID = "SET_TABSHEET_TAB_GLOBAL_PANID";
	public static String SET_TABSHEET_TAB_GLOBAL_GW_EUI64 = "SET_TABSHEET_TAB_GLOBAL_GW_EUI64";
	public static String SET_TABSHEET_TAB_GLOBAL_GW_PREFIX = "SET_TABSHEET_TAB_GLOBAL_GW_PREFIX";
	...
	public static String SET_TABSHEET_TAB_GLOBAL_CLOCK_TIME = "SET_TABSHEET_TAB_GLOBAL_CLOCK_TIME";
	...
	public static String SET_TABSHEET_TAB_GLOBAL_DB_DELETE_BEFORE_POP_HEADER = "SET_TABSHEET_TAB_GLOBAL_DB_DELETE_BEFORE_POP_HEADER";
	public static String SET_TABSHEET_TAB_GLOBAL_DB_DELETE_BEFORE_POP_TEXT = "SET_TABSHEET_TAB_GLOBAL_DB_DELETE_BEFORE_POP_TEXT";
	...
	public static String SET_TABSHEET_TAB_GLOBAL_NETWORK_DNS1 = "SET_TABSHEET_TAB_GLOBAL_NETWORK_DNS1";
	public static String SET_TABSHEET_TAB_GLOBAL_NETWORK_DNS2 = "SET_TABSHEET_TAB_GLOBAL_NETWORK_DNS2";
	...
	public static String DEVICE_V_SOURCE_BAT = "DEVICE_V_SOURCE_BAT";
	public static String DEVICE_V_SOURCE_NET = "DEVICE_V_SOURCE_NET";
	public static String DEVICE_V_SOURCE_UNKNOWN = "DEVICE_V_SOURCE_UNKNOWN";
	
	public static String DEVICE_V_SOURCE_STATE_OK = "DEVICE_V_SOURCE_STATE_OK";
	public static String DEVICE_V_SOURCE_STATE_LOW = "DEVICE_V_SOURCE_STATE_LOW";
	public static String DEVICE_V_SOURCE_STATE_UNKNOWN = "DEVICE_V_SOURCE_STATE_UNKNOWN";
