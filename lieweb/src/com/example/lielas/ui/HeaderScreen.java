...
public class HeaderScreen extends Panel{
	...
	public HeaderScreen(final LielasApplication app){
		this.app = app;
		
		setSizeFull();
		setScrollable(false);
		
		VerticalLayout vlo = (VerticalLayout) getContent();
		vlo.setMargin(false);
		vlo.setSpacing(false); 
		vlo.setSizeFull();
		
		Label leftSpacer = new Label();
		leftSpacer.setWidth(20, Sizeable.UNITS_PIXELS);
		
		Label middleSpacer = new Label();
		middleSpacer.setWidth(100, Sizeable.UNITS_PERCENTAGE);
		
		FirstLanguageLbl = new NativeButton("EN");
		SecondLanguageLbl = new NativeButton("DE");
		Label delimiterLbl = new Label("|");
		
		FirstLanguageLbl.setWidth(30, Sizeable.UNITS_PIXELS);
		FirstLanguageLbl.setHeight(28, Sizeable.UNITS_PIXELS);
		FirstLanguageLbl.setStyleName("header-language");
		FirstLanguageLbl.addStyleName(BaseTheme.BUTTON_LINK);
		delimiterLbl.setWidth(10, Sizeable.UNITS_PIXELS);
		delimiterLbl.setHeight(28, Sizeable.UNITS_PIXELS);
		delimiterLbl.setStyleName("header-language");
		delimiterLbl.addStyleName(BaseTheme.BUTTON_LINK);
		SecondLanguageLbl.setWidth(30, Sizeable.UNITS_PIXELS);
		SecondLanguageLbl.setStyleName("header-language");
		SecondLanguageLbl.addStyleName(BaseTheme.BUTTON_LINK);
		SecondLanguageLbl.setHeight(28, Sizeable.UNITS_PIXELS);
		
		FirstLanguageLbl.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});
		
		SecondLanguageLbl.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});
		...
		lo.setHeight(73, Sizeable.UNITS_PIXELS);
		lo.setWidth(100, Sizeable.UNITS_PERCENTAGE);
		lo.setMargin(false);
		...
		DeviceManagerButton.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});
		...
		DownloadButton.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});
		...
		AnalyseButton.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});
		...
		EventManagerButton.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});	
		...
		OptionsButton.addListener(new NativeButton.ClickListener() {
			public void buttonClick(ClickEvent event) {
				ButtonClickHandler(event);
			}
		});
		...
		HelpButton.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});
		...
		LogoutButton.addListener(new NativeButton.ClickListener(){
			public void buttonClick(ClickEvent event){
				ButtonClickHandler(event);
			}
		});		
